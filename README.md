...
[Preparation (API Key and installing dependencies)](#preparation-%28api-key-and-installing-dependencies%29) 
...
Here I provide background on some tech not used in the
course and links for further reading.

### Flask

I use Flask for creating the API interface for the application.
